                                    ...
                                    <div class="col-12 col-md-6 d-flex align-items-center justify-content-end mx-0 px-0">
                                        ...
                                        <div class="dropdown mr-2">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="userStatusDropdown">
                                                ...
                                                <li><a class="dropdown-item" href="#">Malabon</a></li>
                                                <li><a class="dropdown-item" href="#">Sinabacan</a></li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="dropdown mr-2">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="userStatusDropdown">
                                                <li><a class="dropdown-item" href="#">Show All</a></li>
                                                <li><a class="dropdown-item" href="#">Zone 1001</a></li>
                                                <li><a class="dropdown-item" href="#">Zone 1002</a></li>
                                                <li><a class="dropdown-item" href="#">Zone 1003</a></li>
                                            </ul>
                                        </div>
