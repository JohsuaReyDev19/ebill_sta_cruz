...
<body id="page-top">
    <div class="d-none" id="users-declined"></div>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-primary"><i class="fa-solid fa-user fa-sm mr-2"></i>Manage Declined Users</h1>
                    </div>
                                ...
                                <div class="card-header py-3">
                                    <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between">
                                            <h6 class="font-weight-bold text-primary mb-0">
                                                List of declined Users Account
                                            </h6>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered nowrap" id="myTable" width="100%" cellspacing="0">
                                            ...
                                            <?php
                                                ...
                                                $display_zonebook = "SELECT * FROM users WHERE deleted = 0 AND status = 2 AND role = 2";
