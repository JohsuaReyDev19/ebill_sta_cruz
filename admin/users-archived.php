...
<body id="page-top">
    <div class="d-none" id="users-archived"></div>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-primary"><i class="fa-solid fa-user fa-sm mr-2"></i>Manage Archived Users</h1>
                    </div>
                                ...
                                <div class="card-header py-3">
                                    <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between">
                                            <h6 class="font-weight-bold text-primary mb-0">
                                                List of Archived Users Account
                                            </h6>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered nowrap" id="myTable" width="100%" cellspacing="0">
                                            ...
                                            <?php
                                                ...
                                                $display_zonebook = "SELECT * FROM users WHERE deleted = 1 AND role = 2";
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $deleted_text; ?></td>
                                                    <td class="text-center">
                                                        <a href="#" class="btn btn-sm btn-warning restore-user-btn"
    ...
    <script>
        $(document).ready(function () {
            $('.restore-user-btn').on('click', function (e) {
                e.preventDefault();
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                if (response.trim() === 'success') {
                                    Swal.fire({
                                        title: 'Restored!',
                                        text: 'User account has been restored successfully.',
                                        icon: 'success'
                                    }).then(() => {
                                        location.reload();
                                    });
                                } else {
                                    Swal.fire('Error', 'Something went wrong while restoring user.', 'error');
                                }
                            },
                            error: function () {
