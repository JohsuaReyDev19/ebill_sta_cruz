        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <div class="form-group">
                    <label class="form-label" for="gender" id="addCons">Gender <span class="text-primary">*</span></label>
                    <select class="form-control custom-select" name="gender" id="gender" required id="inputFields">
