        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <div class="form-group mb-2">
                    <label class="form-label" id="addCons">Last Name <span class="text-primary">*</span></label>
                    <input type="text" class="form-control" name="last_name" required>
                    <div class="invalid-feedback">Please enter concessionare's last name.</div>
                </div>
                <!-- First Name -->
                <div class="form-group mb-2">
                    <label class="form-label" id="addCons">First Name <span class="text-primary">*</span></label>
                    <input type="text" class="form-control" name="first_name" required id="inputFields">
                    <div class="invalid-feedback">Please enter concessionare's first name.</div>
                </div>
                <!-- Middle Name -->
                <div class="form-group mb-2">
                    <label class="form-label" id="addCons">Middle Name</label>
                    <input type="text" class="form-control" name="middle_name">
                </div>
                
                <!-- Suffix Name -->
                <div class="form-group mb-2">
                    <label class="form-label" id="addCons">Suffix Name</label>
                    <select class="form-control custom-select" name="suffix_name" required id="inputFields">
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <div class="form-group">
                    <label class="form-label" for="accountType" id="addCons">Account Type <span class="text-primary">*</span></label>
                    <select class="form-control custom-select" name="accountType" id="accountType" required id="inputFields">
                ...
                <div class="form-group">
                    <label class="form-label" for="position" id="addCons">Position<span class="text-primary">*</span></label>
                    <input type="text" class="form-control" name="position" required id="inputFields">
                    <div class="invalid-feedback">Please select the concessionare's gender.</div>
                </div>
            </div>
        </div>
