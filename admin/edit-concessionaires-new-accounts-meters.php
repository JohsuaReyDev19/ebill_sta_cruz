            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="edit-concessionaires-accounts.php?title=Accounts&id=<?php echo urlencode($_GET['concessionaire_id']); ?>" class="btn btn-secondary mb-0 shadow-sm"><i class="fas fa-circle-chevron-left mr-2"></i>Back</a>
                    </div>
