...
<body id="page-top">
    <div class="d-none" id="service-status-settings"></div>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-primary"><i class="fa-solid fa-link fa-sm mr-2"></i>Service Status Settings</h1>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-column flex-md-row">
                                    <div class="col-12 col-md-6 d-flex align-items-center justify-content-start mx-0 px-0 mb-2 mb-md-0">
                                        <h6 class="font-weight-bold text-primary mb-0">List of Service Status</h6>
                                    </div>
                                    <div class="col-12 col-md-6 d-flex align-items-center justify-content-end mx-0 px-0">
                                        <div class="col-12 col-md-4 float-right mx-0 px-0">
                                            <a data-toggle="modal" data-target="#addNew" class="btn btn-success shadow-sm w-100 h-100"><i class="fa-solid fa-plus mr-1"></i>Add Service Status</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- Card Body -->
                                        ...
                                        <table class="table table-bordered nowrap" id="myTable" width="100%" cellspacing="0">
                                            <thead class="">
                                                <tr>
                                                    ...
                                                    <th scope="col">Service Status Remarks</th>                                               
                                            ...
                                            <?php
                                                ...
                                                $display_service_status_settings = "SELECT * FROM service_status_settings WHERE deleted = 0";
                                                $sqlQuery = mysqli_query($con, $display_service_status_settings) or die(mysqli_error($con));
                                                ...
                                                while($row = mysqli_fetch_array($sqlQuery)) {
                                                    ...
                                                    $service_status_remarks = $row['service_status_remarks'];
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo htmlspecialchars($service_status_remarks); ?></td>
                                                    <td class="text-center">
                                                        <a class="btn btn-sm btn-primary" data-toggle="modal" data-target="#edit_<?php echo $service_status_id; ?>"><i class="fa-solid fa-edit"></i></a>
                                                        <a href="#" class="btn btn-sm btn-danger delete-service-btn"
                                                           data-service-id="<?php echo $service_status_id; ?>"
                                                           data-service-name="<?php echo htmlspecialchars($service_status); ?>"
                                                           data-service-remarks="<?php echo htmlspecialchars($service_status_remarks); ?>">
                                                ...
                                                <?php
                                                    $counter++;
                                                    include('modal/service_status_edit_modal.php');
                                                }
                                                ?>
                                            </tbody>
                                        </table>
                        ...
                        <?php include('modal/service_status_add_modal.php'); ?>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#addServiceStatus').on('click', function(e) {
                ...
                if (fieldsAreValid) {
                    ...
                    $.ajax({
                        url: 'action/add_service_status.php', // URL to submit the form data
                        type: 'POST',
                        ...
                        success: function(response) {
                            ...
                            if (response === 'success') {
                                Swal.fire({
                                    icon: 'success',
                                    title: 'Service Status added successfully!',
                                ...
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Failed to add Service Status!',
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.delete-service-btn').on('click', function(e) {
                ...
                var serviceName = decodeURIComponent(deleteButton.data('service-name'));
                var ServiceRemarks = decodeURIComponent(deleteButton.data('service-remarks'));

                Swal.fire({
                    title: 'Delete Service Remarks',
                    html: "You are about to delete the following service status:<br><br>" +
                          "<strong>Service Status:</strong> " + serviceName + "<br>" +
                          "<strong>Service Status Remarks:</strong> " + ServiceRemarks + "<br>",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: 'action/delete_service_status.php',
                            type: 'POST',
                            data: {
                                service_status_id: serviceID
                            },
                            success: function(response) {
                                if (response.trim() === 'success') {
                                    Swal.fire(
                                        'Deleted!',
                                        'Service Status has been deleted.',
                                        'success'
                                    ).then(() => {
                                        location.reload();
                                    });
                                    ...
                                    Swal.fire(
                                        'Error!',
                                        'Failed to delete service status.',
                                        'error'
                                    );
                                }
                            },
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '[id^="updateServiceStatus_"]', function(e) {
                e.preventDefault(); // Prevent default form submission
                ...
                if (fieldsAreValid) {
                    $.ajax({
                        url: 'action/update_service_status.php', // URL to submit the form data
                        type: 'POST',
