    ...
    <li class="nav-item">
        ...
        <div id="systemSettingsCollapse" class="collapse">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="manage-barangay.php?title=Manage Barangay">Manage Barangay</a>
                ...
                <a class="collapse-item" href="meter-size-settings.php?title=Meter Size">Manage Meter</a>
