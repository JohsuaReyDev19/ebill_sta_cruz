                        ...
                        <?php
                            if (isset($_GET['title'])) {
                                ...
                                elseif($title == "Account List"){
                                    ...
                                    echo '<i class="fa-solid fa-user fa-sm mr-2"></i>';
                                    echo $title;
                                }elseif($title == "Disconnection"){
                                    echo '<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-cloud-off-icon lucide-cloud-off mr-2"><path d="M10.94 5.274A7 7 0 0 1 15.71 10h1.79a4.5 4.5 0 0 1 4.222 6.057"/><path d="M18.796 18.81A4.5 4.5 0 0 1 17.5 19H9A7 7 0 0 1 5.79 5.78"/><path d="m2 2 20 20"/></svg>';
                                    echo $title;
                                }
