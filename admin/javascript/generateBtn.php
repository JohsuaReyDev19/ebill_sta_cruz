...
$(document).ready(function () {
    ...
    let printContent = `<html><head><title>Water Bill Notice</title>
    <style>
        @page { size: 102mm 152mm; margin: 5mm; }
        body { font-family: 'Courier New', monospace; margin: 0; }
        .wrapper { width: 100%; height: 100%; }
        .notice { width: 100%; height: 100%; box-sizing: border-box; page-break-after: always; }

        .header-flex { display: flex; align-items: center; justify-content: center; gap: 6px; margin-bottom: 5px; }
        .logo img { width: 30px; height: 30px; }
        .header-text { text-align: center; }

        .title { font-size: 11pt; font-weight: bold; }
        .section-title { font-size: 9pt; text-align: center; margin-top: 5px; }
        .text { font-size: 8pt; line-height: 1.3; }
        .label { display: inline-block; width: 90px; }
        .label2 { display: inline-block; width: 130px; }
        .reminders { font-size: 6pt; margin-top: 5px; text-align: justify; }

        @media print {
            body { margin: 0; }
            .notice { page-break-after: always; }
        }
    </style>
