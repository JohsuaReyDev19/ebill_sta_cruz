...
button#login-btn:after {
    position: absolute;
    top: 80%; /* Start from 80% (at the bottom) */
    left: 0;
    width: 100%;
    height: 100%;
    background: #5661C7;
    content: "";
    z-index: -2;
    transition: transform 0.5s ease-in-out; /* Longer duration and smoother timing */
}
...
button#login-btn:hover::after {
    transform: translateY(-80%); /* Move upwards */
    transition: transform 0.5s ease-in-out; /* Longer duration and smoother timing */
}
...
#preloader {
    background-image: url('../img/<?php echo $currentSettings['system_preloader'] ?? 'preloader.png'; ?>');
    width: 120px;
    height: 120px;
