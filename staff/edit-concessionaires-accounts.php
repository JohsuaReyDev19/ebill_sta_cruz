            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="concessionaires.php?title=Concessionaires" class="btn btn-secondary mb-0 shadow-sm"><i class="fas fa-circle-chevron-left mr-2"></i>Back</a>
                    </div>
                                ...
                                <div class="card-header py-3 d-flex flex-column flex-md-row">
                                    ...
                                    <div class="col-12 col-md-6 d-flex align-items-center justify-content-end mx-0 px-0">
                                        <div class="col-12 col-md-4 float-right mx-0 px-0">
                                            <a href="edit-concessionaires-new-accounts-meters.php?concessionaire_id=<?php echo urlencode($_GET['id']); ?>" class="btn btn-success shadow-sm w-100 h-100"><i class="fa-solid fa-plus mr-1"></i>Add Account</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- Card Body -->
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a href="edit-concessionaires-accounts-change-meters.php?concessionaire_id=<?php echo urlencode($_GET['id']); ?>&meters_id=<?php echo urlencode($encryptedData); ?>" class="btn btn-sm btn-success shadow-sm"><i class="fa-solid fa-gauge-simple"></i> Change Meter</a>
