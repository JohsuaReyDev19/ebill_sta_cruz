        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="row float-left ml-2">
                    <h4 class="modal-title float-left text-success" id="myModalLabel">
                        <i class="fas fa-plus fa-sm"></i> Add New Account Type
                    </h4>
                </div>
            ...
            <form method="POST">
                <div class="modal-body">
                    <div class="container-fluid">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" id="account_type" name="account_type" type="text" required>
                        ...
                        <div class="form-group mb-3">
                            <label class="control-label modal-label" for="account_type_remarks">Account Type Remarks</label>
                            <textarea id="account_type_remarks" name="account_type_remarks" class="form-control" required></textarea>
                            <div class="invalid-feedback">
                ...
                <div class="modal-footer col-12 px-4">
                    ...
                    <button type="submit" name="edit" class="btn btn-success col-12 col-sm-3" id="addAccountType">Save</button>
                </div>
            </form>
        </div>
    </div>
