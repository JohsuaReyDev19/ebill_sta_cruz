            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-primary"><i class="fa-solid fa-gauge-simple fa-sm mr-2"></i>Change Account & Meter of <?php echo $full_name; ?></h1>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-column flex-md-row">
                                    <div class="col-12 d-flex align-items-center justify-content-start mx-0 px-0 mb-2 mb-md-0">
                                        <h6 class="font-weight-bold text-primary mb-0">Account Info</h6>
                                    </div>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
